String getTextContents(String key) {
  const Map<String, String> contents = {
    ...
    "secondFragment":
        "O cálculo do Índice de Massa Corporal é feito usando a seguinte formula: Peso ÷ (altura x altura).",
    "thirdFragment": 
        "O resultado desse cálculo mostra a categoria em que a pessoa se encontra conforme a classificação adotada pela OMS. Confira a classificação na imagem abaixo:",
    "fourthFragment": 
        "A fórmula do IMC é simples e qualquer um pode calcular em casa de forma fácil, seja com papel e caneta ou com ferramentas como esta. Porém, é importante saber interpretar o resultado e entender o que de fato ele diz sobre a sua saúde e procurar, se necessário, orientação de um profissional de saúde.",
  };
